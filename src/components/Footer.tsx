          ...
          <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-10 text-center">
                ...
                <div className="flex justify-center items-center gap-x-8 md:gap-x-12 flex-wrap">
                    ...
                    <a href="https://blackheavenshop.com/Beerrings-Classic-Edition" target="_blank" rel="noopener noreferrer" title="zu Koloss" aria-label="Sponsor Koloss" className="opacity-80 hover:opacity-100 transition-opacity duration-300">
                    ...
                    <a href="https://solide.myspreadshop.de/" target="_blank" rel="noopener noreferrer" title="zu Solide" aria-label="Sponsor Solide" className="opacity-80 hover:opacity-100 transition-opacity duration-300">
